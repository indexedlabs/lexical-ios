...
## Upload and embed file references in descriptions

```bash
mt file upload ./screenshots/flow.png
# Use returned file_id in rich text:
# ![[file <file_id>]]  block embed
# [[file <file_id>]]   inline mention
mt link --from <spec-or-task-id> --rel documented_by --to-type file --to-ref mighty-file:<file_id> -d "Screenshot/reference artifact"
```
