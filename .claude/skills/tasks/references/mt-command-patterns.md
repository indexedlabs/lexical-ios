...
## Upload and reference files (screenshots/docs)

```bash
mt file upload ./screenshots/flow.png
# returns: file_id=<uuid>, ref=mighty-file:<uuid>

# Rich text:
# ![[file <uuid>]]   block embed
# [[file <uuid>]]    inline mention

mt link --from <task-or-spec-id> --rel documented_by --to-type file --to-ref mighty-file:<uuid> -d "Screenshot evidence"
```
